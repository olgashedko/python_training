...
def test_delete_contact_from_group(app, db, check_ui, ormdb):
    ...
    if len(ormdb.get_contacts_not_in_any_group()) == len(db.get_contact_list()):
    ...
    groups_with_contacts = ormdb.get_groups_with_contacts()
    group2 = random.choice(groups_with_contacts)
    contacts_in_group_before_deletion = ormdb.get_contacts_in_group(group2)
    ...
    contacts_in_group_after_deletion = ormdb.get_contacts_in_group(group2)
