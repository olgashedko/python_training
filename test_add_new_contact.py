...
class AddNewGroup(unittest.TestCase):
    ...
    def test_add_new_group(self):
        ...
        self.add_new_contact(wd, "Petr", "Petrovich", "Petrov", "Petya", "Company", "title", "SPb, str 1-1-1",
                             "111-11-11", "+7921-111-11-11", "222-22-22", "222-22-22", "test@test.com",
                             "test2@test.com", "test3@test.com", "localpage", "11", "2000", "November", "23",
                             "November", "2000")
    ...
    def add_new_contact(self, wd, firstname, middlename, lastname, nickname, company, title, address, home, mobile,
                        work, fax, email, email2, email3, homepage, bday, byear, bmonth, aday, amonth, ayear):
